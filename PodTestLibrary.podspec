...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/liyq5/PodTestLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'liyq5' => 'liyq5@asiainfo.com' }
  s.source           = { :git => 'https://github.com/liyq5/PodTestLibrary.git', :tag => s.version.to_s }
